...
public class OrderControllerIT {
    ...
    void setup() throws Exception {
        ...
        invalidToken = adminToken + "xpto"; // simulate wrong token
    ...
    @Test
    void findByIdShouldReturnOrderDTOWhenIdExistsAndAdminLoggedIn() throws Exception {
    ...
    @Test
    void findByIdShouldReturnOrderDTOWhenIdExistsAndClientLoggedIn() throws Exception {
    ...
    @Test
    void findByIdShouldReturnForbiddenWhenIdExistsAndClientLoggedInAndOrderDoesNotBelongUser() throws Exception {
    ...
    @Test
    void findByIdShouldReturnNotFoundWhenIdDoesNotExistsAndAdminLoggedIn() throws Exception {
    ...
    @Test
    void findByIdShouldReturnNotFoundWhenIdDoesNotExistsAndClientLoggedIn() throws Exception {
